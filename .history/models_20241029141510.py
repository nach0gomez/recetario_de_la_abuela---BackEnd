...
class Favoritos(models.Model):
    id_favorito = models.IntegerField(db_column='id_favorito',primary_key=True)
...
class RecetaIngredientes(models.Model):
    id_receta_ingredientes = models.AutoField(db_column='id_receta_ingredientes', primary_key=True)  # Usa un nombre sin guion en el modelo.
